export { RPG_CAPABILITY_VERSIONS, RPG_IR_IDENTITY, RPG_IR_MAJOR, RPG_OPERATION_VERSIONS, } from './generated-vocabulary.js';
export type { RpgCapabilityId, RpgOperationId, } from './generated-vocabulary.js';
...
export type RpgIrAreaShape = {
    ...
    readonly kind: 'orthogonalLine';
    readonly length: number;
};
export type RpgIrSubject = 'actor' | 'target';
export type RpgIrRollScope = 'shared' | 'perTarget' | 'none';
export type RpgIrComparison = 'equal' | 'notEqual' | 'lessThan' | 'lessThanOrEqual' | 'greaterThan' | 'greaterThanOrEqual';
...
export type RpgIrFormula = {
    ...
    readonly kind: 'add';
    readonly terms: readonly RpgIrFormula[];
} | {
    readonly kind: 'dice';
    readonly count: number;
...
export type RpgIrPredicate = {
    ...
    readonly kind: 'all';
    readonly predicates: readonly RpgIrPredicate[];
} | {
    readonly kind: 'any';
    readonly predicates: readonly RpgIrPredicate[];
};
...
export type RpgIrProgram = {
    ...
    readonly steps: readonly RpgIrProgram[];
} | {
    readonly kind: 'when';
    readonly predicate: RpgIrPredicate;
