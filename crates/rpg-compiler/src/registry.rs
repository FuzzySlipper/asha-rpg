...
const REGISTRATIONS: &[RpgOperationRegistration] = &[
    ...
    RpgOperationRegistration {
        ...
        accepted_events: &["MovementTransition"],
        trace_behavior: "Record the operation path, origin, destination, distance validation, and commit.",
        replay_implications: "Replay verifies the accepted MovementTransition event and resulting position view.",
    },
    RpgOperationRegistration {
        ...
        replay_implications: "Replay verifies the selected route binding, accepted MovementTransition event, and resulting position view.",
    },
    RpgOperationRegistration {
        id: "operation.push",
        version: 1,
        reads: &[RpgCapabilityId::Position],
        mutation_owner: RpgCapabilityId::Position,
        validation_behavior: "Request and apply one bounded source-relative authority route with stop-before-blocked policy.",
        accepted_events: &["MovementTransition"],
        trace_behavior: "Record the source, moved participant, exact forced route, and non-provoking transition.",
        replay_implications: "Replay verifies the authority-derived push route and resulting position view.",
    },
    RpgOperationRegistration {
        id: "operation.slide",
        version: 1,
        reads: &[RpgCapabilityId::Position],
        mutation_owner: RpgCapabilityId::Position,
        validation_behavior: "Request one bounded authority-projected forced route choice.",
        accepted_events: &["MovementTransition"],
        trace_behavior: "Record the selected typed slide route and non-provoking transition.",
        replay_implications: "Replay verifies the selected slide route binding and resulting position view.",
    },
    RpgOperationRegistration {
