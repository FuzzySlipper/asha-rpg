...
pub use rpg_core::*;
pub use rpg_ir::{
    CharacterClassSchema, CharacterFeatureRollContribution, CharacterFeatureSchema,
    CompiledCharacterClass, CompiledCharacterFeature, CompiledContentPolicyBinding,
    CompiledItemDefinition, CompiledParticipantProfile, CompiledPlayBundleArtifact,
